    ...
    mongoose.connection.db.dropDatabase()
        .then(async () => {
            ...
            const user = new UsuarioSchema({
                ...
                img: `https://backendpass.fly.dev/image/businessman.png`,
...
function events(userID, listCategories, listGuests, listCareers) {
    ...
    let list = [
        //negocios
        {
            ...
            image: `https://backendpass.fly.dev/image/events/ExpoNegocios2023.png`,
            activitieIds: [],
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/liderazgo2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/ForoEmpresarial2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/CumbredeInnovación2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Marketing2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Música,Arte,Tecnología
        {
            ...
            image: `https://backendpass.fly.dev/image/events/portadadeeventoResidenciaDigital2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/ConciertoHolográfico2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/FestivaldeArteyTecnología.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/InstalacióndeArteDigitalInteractivo.jpeg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/ConferenciasobreMúsicayTecnología2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Moda,Comida,Cine
        {
            ...
            image: `https://backendpass.fly.dev/image/events/FashionFilmFestival2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/CineyCenaaciegas2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/FashionWeekFoodTour2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/FestivaldeCineGastronómico2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/DesfiledeModaGourmet2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Ciencia y Viajes
        {
            ...
            image: `https://backendpass.fly.dev/image/events/ExpediciónalaAntártida.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Turismoespacial.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Aventuradeecoturismoenlaselvaamazónica.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/EstaciónEspacialInternacional.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/ViajedeinvestigacióncientíficaalaGranBarreradeCoral.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Literatura,Danza,Fotografía
        {
            ...
            image: `https://backendpass.fly.dev/image/events/FestivaldeLiteraturaInternacional.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Espectáculodedanzacontemporánea.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Exposicióndefotografíadepaisajesnaturales.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Feriadelibrosdefotografía.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Charladecienciasobrelaexploracióndelespacio.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Espectáculo, Feria e Historia
        {
            ...
            image: `https://backendpass.fly.dev/image/events/FeriadelaHistoria.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/EspectáculodelaAntigüedad.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/FeriaMedieval.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/EspectáculodelaRevolución.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/FeriadelRenacimiento.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //deportes
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Torneouniversitariodefútbolmasculino.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Torneouniversitariodebaloncestofemenino.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Competenciauniversitariadenatación.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Partidodeexhibicióndevoleibolmasculino.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Carrerauniversitariadecampotraviesa.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //emprendimiento
        {
            ...
            image: `https://backendpass.fly.dev/image/events/StartupWeekend.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/ConferenciadeEmprendimientoGlobal.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/CharladeEmprendimientoJuvenil.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/ConcursodeEmprendimientoUniversitario.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/ForodeInversióndeEmprendimiento.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Religión,Social,Medio ambiente
        {
            ...
            image: `https://backendpass.fly.dev/image/events/portadaeventoConferenciasobresostenibilidadyreligión.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/portadaeventoDíadelimpiezacomunitaria.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Forodediscusiónsobrelapobreza.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Tallerdecompostaje.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Charlasobreladiversidadcultural.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Danza,Fotografía,Conferencia,
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Exposicióndefotografía.jpeg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Conferenciasobredanzayfotografía.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Tallerdefotografíadedanza.jpeg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Presentacióndedanzafotográfica.jpeg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Conferenciadefotógrafosdedanza.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Cine, Educación y Política
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Cinefórumdeeducaciónpolítica.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Encuentrodecineastaspolíticos.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Conferenciasobreelpapeldelcineenlaeducaciónpolítica.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Festivaldecinepolíticoyeducativo.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Foroeducativosobreelcinepolítico.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Tecnología
        {
            ...
            image: `https://backendpass.fly.dev/image/events/WebSummit.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/CES.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/GoogleI:O.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/WWDC.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/TechCrunchDisrupt.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Religión, Social, Medio ambiente, Espectáculo, Feria, y Historia
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Feriareligiosadelacomunidad.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Exposiciónsobrelahistoriareligiosadelaciudad.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/conciertobeneficoporlajusticiasocial.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Feriadearteycultura.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/events/Visitaguiadaasitioshistóricosnaturales.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
    ...
    let list = [
        {
            ...
            image: `https://backendpass.fly.dev/image/guests/JohnDoe.jpg`,
            user: userID,
            state: true,
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/guests/JaneSmith.jpeg`,
            user: userID,
            state: true,
        },
        {
            ...
            specialty: 'Liderazgo',
            image: `https://backendpass.fly.dev/image/guests/BobJhonson.jpg`,
            user: userID,
            state: true,
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/guests/MariaPerez.jpg`,
            user: userID,
            state: true,
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/guests/CarlosMartinez.jpg`,
            user: userID,
            state: true,
        },
        {
            ...
            specialty: 'Finanzas',
            image: `https://backendpass.fly.dev/image/guests/SusanWong.jpeg`,
            user: userID,
            state: true,
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/guests/MarkDavis.jpg`,
            user: userID,
            state: true,
        },
        {
            ...
            image: `https://backendpass.fly.dev/image/guests/LauraGarcia.jpeg`,
            user: userID,
            state: true,
        }
    ];
...
function categories(userID) {
    let list = [
        {
            title: 'Negocios',
            icon: `https://backendpass.fly.dev/image/icons/briefcase-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Deportes',
            icon: `https://backendpass.fly.dev/image/icons/volleyball-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Música',
            icon: `https://backendpass.fly.dev/image/icons/music-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Arte',
            icon: `https://backendpass.fly.dev/image/icons/palette-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Tecnología',
            icon: `https://backendpass.fly.dev/image/icons/microchip-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Moda',
            icon: `https://backendpass.fly.dev/image/icons/shirt-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Comida',
            icon: `https://backendpass.fly.dev/image/icons/pizza-slice-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Educación',
            icon: `https://backendpass.fly.dev/image/icons/school-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Política',
            icon: `https://backendpass.fly.dev/image/icons/scale-balanced-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Teatro y Cine',
            icon: `https://backendpass.fly.dev/image/icons/masks-theater-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Salud',
            icon: `https://backendpass.fly.dev/image/icons/heart-pulse-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Ciencia',
            icon: `https://backendpass.fly.dev/image/icons/flask-vial-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Viajes',
            icon: `https://backendpass.fly.dev/image/icons/mountain-sun-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Literatura',
            icon: `https://backendpass.fly.dev/image/icons/book-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Danza',
            icon: `https://backendpass.fly.dev/image/icons/dancing-motion-svgrepo-com.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Fotografía',
            icon: `https://backendpass.fly.dev/image/icons/camera-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Conferencia',
            icon: `https://backendpass.fly.dev/image/icons/microphone-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Emprendimiento',
            icon: `https://backendpass.fly.dev/image/icons/lightbulb-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Finanzas',
            icon: `https://backendpass.fly.dev/image/icons/coins-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Medio ambiente',
            icon: `https://backendpass.fly.dev/image/icons/seedling-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Arquitectura',
            icon: `https://backendpass.fly.dev/image/icons/building-regular.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Juegos',
            icon: `https://backendpass.fly.dev/image/icons/gamepad-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Animales',
            icon: `https://backendpass.fly.dev/image/icons/cat-solid.svg`,
            user: userID,
            state: true
        },
    ];
