    ...
    mongoose.connection.db.dropDatabase()
        .then(async () => {
            ...
            const user = new UsuarioSchema({
                ...
                password: '12345678',
                img: `http://localhost:${process.env.PORT}/image/businessman.png`,
...
function events(userID, listCategories, listGuests, listCareers) {
    ...
    let list = [
        //negocios
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/ExpoNegocios2023.png`,
            activitieIds: [],
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/liderazgo2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/ForoEmpresarial2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/CumbredeInnovación2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Marketing2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Música,Arte,Tecnología
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/portadadeeventoResidenciaDigital2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/ConciertoHolográfico2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/FestivaldeArteyTecnología.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/InstalacióndeArteDigitalInteractivo.jpeg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/ConferenciasobreMúsicayTecnología2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Moda,Comida,Cine
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/FashionFilmFestival2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/CineyCenaaciegas2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/FashionWeekFoodTour2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/FestivaldeCineGastronómico2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/DesfiledeModaGourmet2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Ciencia y Viajes
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/ExpediciónalaAntártida.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Turismoespacial.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Aventuradeecoturismoenlaselvaamazónica.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/EstaciónEspacialInternacional.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/ViajedeinvestigacióncientíficaalaGranBarreradeCoral.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Literatura,Danza,Fotografía
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/FestivaldeLiteraturaInternacional.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Espectáculodedanzacontemporánea.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Exposicióndefotografíadepaisajesnaturales.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Feriadelibrosdefotografía.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Charladecienciasobrelaexploracióndelespacio.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Espectáculo, Feria e Historia
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/FeriadelaHistoria.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/EspectáculodelaAntigüedad.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/FeriaMedieval.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/EspectáculodelaRevolución.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/FeriadelRenacimiento.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //deportes
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Torneouniversitariodefútbolmasculino.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Torneouniversitariodebaloncestofemenino.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Competenciauniversitariadenatación.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Partidodeexhibicióndevoleibolmasculino.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Carrerauniversitariadecampotraviesa.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //emprendimiento
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/StartupWeekend.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/ConferenciadeEmprendimientoGlobal.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/CharladeEmprendimientoJuvenil.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/ConcursodeEmprendimientoUniversitario.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/ForodeInversióndeEmprendimiento.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Religión,Social,Medio ambiente
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/portadaeventoConferenciasobresostenibilidadyreligión.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/portadaeventoDíadelimpiezacomunitaria.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Forodediscusiónsobrelapobreza.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Tallerdecompostaje.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Charlasobreladiversidadcultural.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Danza,Fotografía,Conferencia,
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Exposicióndefotografía.jpeg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Conferenciasobredanzayfotografía.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Tallerdefotografíadedanza.jpeg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Presentacióndedanzafotográfica.jpeg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Conferenciadefotógrafosdedanza.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Cine, Educación y Política
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Cinefórumdeeducaciónpolítica.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Encuentrodecineastaspolíticos.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Conferenciasobreelpapeldelcineenlaeducaciónpolítica.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Festivaldecinepolíticoyeducativo.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Foroeducativosobreelcinepolítico.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Tecnología
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/WebSummit.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/CES.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/GoogleI:O.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/WWDC.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/TechCrunchDisrupt.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Religión, Social, Medio ambiente, Espectáculo, Feria, y Historia
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Feriareligiosadelacomunidad.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Exposiciónsobrelahistoriareligiosadelaciudad.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/conciertobeneficoporlajusticiasocial.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Feriadearteycultura.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/events/Visitaguiadaasitioshistóricosnaturales.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
    ...
    let list = [
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/guests/JohnDoe.jpg`,
            user: userID,
            state: true,
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/guests/JaneSmith.jpeg`,
            user: userID,
            state: true,
        },
        {
            ...
            specialty: 'Liderazgo',
            image: `http://localhost:${process.env.PORT}/image/guests/BobJhonson.jpg`,
            user: userID,
            state: true,
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/guests/MariaPerez.jpg`,
            user: userID,
            state: true,
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/guests/CarlosMartinez.jpg`,
            user: userID,
            state: true,
        },
        {
            ...
            specialty: 'Finanzas',
            image: `http://localhost:${process.env.PORT}/image/guests/SusanWong.jpeg`,
            user: userID,
            state: true,
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/guests/MarkDavis.jpg`,
            user: userID,
            state: true,
        },
        {
            ...
            image: `http://localhost:${process.env.PORT}/image/guests/LauraGarcia.jpeg`,
            user: userID,
            state: true,
        }
    ];
...
function categories(userID) {
    let list = [
        {
            title: 'Negocios',
            icon: `http://localhost:${process.env.PORT}/image/icons/briefcase-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Deportes',
            icon: `http://localhost:${process.env.PORT}/image/icons/volleyball-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Música',
            icon: `http://localhost:${process.env.PORT}/image/icons/music-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Arte',
            icon: `http://localhost:${process.env.PORT}/image/icons/palette-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Tecnología',
            icon: `http://localhost:${process.env.PORT}/image/icons/microchip-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Moda',
            icon: `http://localhost:${process.env.PORT}/image/icons/shirt-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Comida',
            icon: `http://localhost:${process.env.PORT}/image/icons/pizza-slice-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Educación',
            icon: `http://localhost:${process.env.PORT}/image/icons/school-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Política',
            icon: `http://localhost:${process.env.PORT}/image/icons/scale-balanced-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Teatro y Cine',
            icon: `http://localhost:${process.env.PORT}/image/icons/masks-theater-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Salud',
            icon: `http://localhost:${process.env.PORT}/image/icons/heart-pulse-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Ciencia',
            icon: `http://localhost:${process.env.PORT}/image/icons/flask-vial-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Viajes',
            icon: `http://localhost:${process.env.PORT}/image/icons/mountain-sun-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Literatura',
            icon: `http://localhost:${process.env.PORT}/image/icons/book-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Danza',
            icon: `http://localhost:${process.env.PORT}/image/icons/dancing-motion-svgrepo-com.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Fotografía',
            icon: `http://localhost:${process.env.PORT}/image/icons/camera-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Conferencia',
            icon: `http://localhost:${process.env.PORT}/image/icons/microphone-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Emprendimiento',
            icon: `http://localhost:${process.env.PORT}/image/icons/lightbulb-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Finanzas',
            icon: `http://localhost:${process.env.PORT}/image/icons/coins-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Medio ambiente',
            icon: `http://localhost:${process.env.PORT}/image/icons/seedling-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Arquitectura',
            icon: `http://localhost:${process.env.PORT}/image/icons/building-regular.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Juegos',
            icon: `http://localhost:${process.env.PORT}/image/icons/gamepad-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Animales',
            icon: `http://localhost:${process.env.PORT}/image/icons/cat-solid.svg`,
            user: userID,
            state: true
        },
    ];
