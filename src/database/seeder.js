...
function events(userID, listCategories, listGuests, listCareers) {
    ...
    let list = [
        //negocios
        {
            ...
            image: `http://localhost:8001/image/events/ExpoNegocios2023.png`,
            activitieIds: [],
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/liderazgo2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/ForoEmpresarial2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/CumbredeInnovación2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Marketing2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Música,Arte,Tecnología
        {
            ...
            image: `http://localhost:8001/image/events/portadadeeventoResidenciaDigital2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/ConciertoHolográfico2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/FestivaldeArteyTecnología.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/InstalacióndeArteDigitalInteractivo.jpeg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/ConferenciasobreMúsicayTecnología2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Moda,Comida,Cine
        {
            ...
            image: `http://localhost:8001/image/events/FashionFilmFestival2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/CineyCenaaciegas2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/FashionWeekFoodTour2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/FestivaldeCineGastronómico2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/DesfiledeModaGourmet2023.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Ciencia y Viajes
        {
            ...
            image: `http://localhost:8001/image/events/ExpediciónalaAntártida.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Turismoespacial.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Aventuradeecoturismoenlaselvaamazónica.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/EstaciónEspacialInternacional.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/ViajedeinvestigacióncientíficaalaGranBarreradeCoral.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Literatura,Danza,Fotografía
        {
            ...
            image: `http://localhost:8001/image/events/FestivaldeLiteraturaInternacional.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Espectáculodedanzacontemporánea.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Exposicióndefotografíadepaisajesnaturales.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Feriadelibrosdefotografía.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Charladecienciasobrelaexploracióndelespacio.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Espectáculo, Feria e Historia
        {
            ...
            image: `http://localhost:8001/image/events/FeriadelaHistoria.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/EspectáculodelaAntigüedad.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/FeriaMedieval.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/EspectáculodelaRevolución.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/FeriadelRenacimiento.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //deportes
        {
            ...
            image: `http://localhost:8001/image/events/Torneouniversitariodefútbolmasculino.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Torneouniversitariodebaloncestofemenino.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Competenciauniversitariadenatación.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Partidodeexhibicióndevoleibolmasculino.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Carrerauniversitariadecampotraviesa.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //emprendimiento
        {
            ...
            image: `http://localhost:8001/image/events/StartupWeekend.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/ConferenciadeEmprendimientoGlobal.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/CharladeEmprendimientoJuvenil.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/ConcursodeEmprendimientoUniversitario.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/ForodeInversióndeEmprendimiento.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Religión,Social,Medio ambiente
        {
            ...
            image: `http://localhost:8001/image/events/portadaeventoConferenciasobresostenibilidadyreligión.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/portadaeventoDíadelimpiezacomunitaria.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Forodediscusiónsobrelapobreza.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Tallerdecompostaje.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Charlasobreladiversidadcultural.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Danza,Fotografía,Conferencia,
        {
            ...
            image: `http://localhost:8001/image/events/Exposicióndefotografía.jpeg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Conferenciasobredanzayfotografía.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Tallerdefotografíadedanza.jpeg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Presentacióndedanzafotográfica.jpeg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Conferenciadefotógrafosdedanza.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Cine, Educación y Política
        {
            ...
            image: `http://localhost:8001/image/events/Cinefórumdeeducaciónpolítica.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Encuentrodecineastaspolíticos.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Conferenciasobreelpapeldelcineenlaeducaciónpolítica.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Festivaldecinepolíticoyeducativo.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Foroeducativosobreelcinepolítico.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Tecnología
        {
            ...
            image: `http://localhost:8001/image/events/WebSummit.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/CES.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/GoogleI:O.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/WWDC.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/TechCrunchDisrupt.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        //Religión, Social, Medio ambiente, Espectáculo, Feria, y Historia
        {
            ...
            image: `http://localhost:8001/image/events/Feriareligiosadelacomunidad.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Exposiciónsobrelahistoriareligiosadelaciudad.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/conciertobeneficoporlajusticiasocial.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Feriadearteycultura.jpg`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
        ...
        },
        {
            ...
            image: `http://localhost:8001/image/events/Visitaguiadaasitioshistóricosnaturales.png`,
            activitieIds: [],
            careerIds: randomList([...listCareers.map(e => e._id)]),
            user: userID,
            guestIds: randomList([...listGuests.map(e => e._id)]),
    ...
    let list = [
        {
            ...
            image: `http://localhost:8001/image/guests/JohnDoe.jpg`,
            user: userID,
            state: true,
        },
        {
            ...
            image: `http://localhost:8001/image/guests/JaneSmith.jpeg`,
            user: userID,
            state: true,
        },
        {
            ...
            specialty: 'Liderazgo',
            image: `http://localhost:8001/image/guests/BobJhonson.jpg`,
            user: userID,
            state: true,
        },
        {
            ...
            image: `http://localhost:8001/image/guests/MariaPerez.jpg`,
            user: userID,
            state: true,
        },
        {
            ...
            image: `http://localhost:8001/image/guests/CarlosMartinez.jpg`,
            user: userID,
            state: true,
        },
        {
            ...
            specialty: 'Finanzas',
            image: `http://localhost:8001/image/guests/SusanWong.jpeg`,
            user: userID,
            state: true,
        },
        {
            ...
            image: `http://localhost:8001/image/guests/MarkDavis.jpg`,
            user: userID,
            state: true,
        },
        {
            ...
            image: `http://localhost:8001/image/guests/LauraGarcia.jpeg`,
            user: userID,
            state: true,
        }
    ];
...
function categories(userID) {
    let list = [
        {
            title: 'Negocios',
            icon: `http://localhost:8001/image/icons/briefcase-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Deportes',
            icon: `http://localhost:8001/image/icons/volleyball-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Música',
            icon: `http://localhost:8001/image/icons/music-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Arte',
            icon: `http://localhost:8001/image/icons/palette-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Tecnología',
            icon: `http://localhost:8001/image/icons/microchip-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Moda',
            icon: `http://localhost:8001/image/icons/shirt-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Comida',
            icon: `http://localhost:8001/image/icons/pizza-slice-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Educación',
            icon: `http://localhost:8001/image/icons/school-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Política',
            icon: `http://localhost:8001/image/icons/scale-balanced-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Teatro y Cine',
            icon: `http://localhost:8001/image/icons/masks-theater-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Salud',
            icon: `http://localhost:8001/image/icons/heart-pulse-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Ciencia',
            icon: `http://localhost:8001/image/icons/flask-vial-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Viajes',
            icon: `http://localhost:8001/image/icons/mountain-sun-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Literatura',
            icon: `http://localhost:8001/image/icons/book-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Danza',
            icon: `http://localhost:8001/image/icons/dancing-motion-svgrepo-com.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Fotografía',
            icon: `http://localhost:8001/image/icons/camera-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Conferencia',
            icon: `http://localhost:8001/image/icons/microphone-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Emprendimiento',
            icon: `http://localhost:8001/image/icons/lightbulb-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Finanzas',
            icon: `http://localhost:8001/image/icons/coins-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Medio ambiente',
            icon: `http://localhost:8001/image/icons/seedling-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Arquitectura',
            icon: `http://localhost:8001/image/icons/building-regular.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Juegos',
            icon: `http://localhost:8001/image/icons/gamepad-solid.svg`,
            user: userID,
            state: true
        },
        {
            title: 'Animales',
            icon: `http://localhost:8001/image/icons/cat-solid.svg`,
            user: userID,
            state: true
        },
    ];
